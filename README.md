...
A pre-trained fasttext and Random Forest model can be found here: https://drive.google.com/file/d/15HFk89lRvMKn29SP5SOmLDOjoqmko475/view?usp=sharing. Feel free to download and use them! You can replace the "randomforest" folder inside the zip file with the "randomforest" folder inside the "Humor_Detection-master" directory, and the "fasttext" folder inside the zip file with the "fasttext" folder inside the "Humor_Detection-master" directory as well.
